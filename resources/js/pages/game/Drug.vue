...
<template>
  <DefaultLayout>
    <section class="max-w-4xl mx-auto mt-8">
      ...
      <div class="space-y-4">
        <div v-for="drug in drugs" :key="drug.id" class="flex items-center justify-between border rounded p-4 shadow-sm">
          <!-- Left: Avatar + Name -->
          <div class="flex items-center space-x-4">
            <img 
              :src="drug.avatar || `https://picsum.photos/seed/${drug.id}/48`" 
              alt="" 
